...
public class AwsS3 {
    ...
    final private String accessKey = "AKIAVVY3HQ4WYHBDG74F";
    final private String secretKey = "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";
    private Regions clientRegion = Regions.AP_NORTHEAST_2;
    private String bucket = "knit-document/thread/";
    ...
    public void upload(MultipartFile file, String key) throws IOException {
        uploadToS3(new PutObjectRequest(this.bucket, key, convertMultiPartToFile(file)));
    }
